	...
	class Node extends EventEmitter{
		constructor (tag, type) {
			...
			Object.defineProperties(this, {
				'childNodes': {value: new NodeList(), writable: false, enumerable: true, configurable: false},
				...
				for (var i = 0, l = this.childNodes.length; i < l; ++i) {
					...
					if (n.nodeType === CONSTANTS.TEXT_NODE) {
						if (!prev) {
							...
							prev = new require('./text.js')(prev.nodeValue + n.nodeValue);
							prev.emit('adopt', n.ownerDocument);
							remove(this, n);
						}
					} else if (prev) {
