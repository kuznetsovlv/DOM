(function () {
	...
	function Node (tag, type) {
		...
		Object.defineProperties(this, {
			...
			'nodeName': {value: contanerTypes.indexOf(type) >= 0? tag.toUpperCase() : '', writable: false, enumerable: true, configurable: false},
	...
	function Element (tag, type) {
		...
		Object.defineProperties(this, {
			'attributes': {value: new Attributess(), writable: false, enumerable: true, configurable: false},
