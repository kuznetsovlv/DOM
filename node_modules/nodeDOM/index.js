(function () {
	...
	function Node (tag, type) {
		Object.defineProperties(this, {
			...
			'appendChild': {
				value: function (elem) {
					if ((!{1: 1, 9: 9, 11: 11}[this.nodeType]) || (elem.ownerDocument !== (this.ownerDocument || this)))
						return undefined;
					if (elem.nodeType === 11)
			...
			'hasChildNodes': {
				get: function () {return !!this.childNodes.length;}, enumerable: true, configurable: false
			},
			'insertBefore': {
				value: function (newChild, refChild) {
					if (!this.childNodes.position(refChild))
						throw "refChild is not a child node";
					if ((!{1: 1, 9: 9, 11: 11}[this.nodeType]) || newChild.ownerDocument !== this.ownerDocument || newChild.ownerDocument !== this)
						return undefined;
